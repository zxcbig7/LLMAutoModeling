...
engine.BuildVars<T>(sets...);          // ONLY form — type comes from the VariableB_/X_/I_ prefix
// BuildCVs / BuildIVs / BuildBVs are BANNED; bounds go into a Constraint_*, never into a build call
