...
namespace OptimModeling.Generators
{
    /// <summary>
    /// 最小可用的 AutoSets source generator。編譯期把宣告式標記補成完整 class。
    ///
    /// 變數：
    ...
    ///
    /// 不依賴、也不修改 OptimFoundation —— 生成 code 以 global:: 全名指向框架型別。
    /// </summary>
    [Generator]
    public sealed class AutoSetsGenerator : IIncrementalGenerator
    {
        private const string VarAttr   = "OptimModeling.OptVarAttribute";
        private const string ParamAttr = "OptimModeling.OptParamAttribute";
