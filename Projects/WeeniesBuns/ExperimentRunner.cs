...
{
    /// <summary>
    /// 參數掃描實驗：同一模型套多組 CplexConfig，每組一次 <see cref="Trial.Capture"/>
    /// 記錄完整設定快照 + 收斂數據，累積成 <see cref="Experiment"/> 輸出
    /// Experiments/&lt;name&gt;.csv + .json。與 solve 模式共用 VariableCreate / BuildModel。
